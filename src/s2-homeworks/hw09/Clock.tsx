...
function Clock() {
    ...
    const start = () => {
        ...
        setTimerId(+setInterval(()=>setDate(new Date(Date.now())), 1000))
        console.log(timerId)
    }
...
setShow(false)
    ...
    const stringDay =  new Intl.DateTimeFormat("eng-GB", {weekday: "long",}).format(date) || <br/> // пишут студенты
    const stringMonth = new Intl.DateTimeFormat("eng-GB", {month: "long",}).format(date)|| <br/> // пишут студенты
